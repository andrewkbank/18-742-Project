...
main(int argc, char **argv)
{
    ...
    for (int j = 0; j < col_length; ++j) {
        ...
        shift_row_right_bytes(expected, (uint8_t *)vals1[j], per_col_bytes,
                              shift_amount);
    ...
    print_shift_summary("shift_right_arbitrary-plus", pattern, shift_amount,
                        checksum, mismatches);
